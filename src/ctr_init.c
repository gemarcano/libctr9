...
void __attribute__((weak)) ctr_libctr9_init(void)
{
	...
	ctr_screen_top = ctr_screen_initialize(cakehax_fbs->top_left, 400, 240, CTR_GFX_PIXEL_RGB8);
	ctr_screen_bottom = ctr_screen_initialize(cakehax_fbs->sub, 320, 240, CTR_GFX_PIXEL_RGB8);
