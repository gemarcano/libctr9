 ...
 *  @returns 0 upon success, anything else means an error.
 */
int ctr_nand_interface_read_sector(void *io, void *buffer, size_t buffer_size, size_t position, size_t count);
 ...
 *  @returns 0 upon success, anything else means an error.
 */
int ctr_nand_interface_write_sector(void *io, const void *buffer, size_t buffer_size, size_t position);
