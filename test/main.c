...
*/
	...
	alignas(4) uint8_t cipher[32] = { 0x76, 0x49, 0xab, 0xac, 0x81, 0x19, 0xb2, 0x46, 0xce, 0xe9, 0x8e, 0x9b, 0x12, 0xe9, 0x19, 0x7d,
	...
	cbc_decrypt(cipher, output_buffer, 0x2, AES_CNT_CBC_DECRYPT_MODE, iv);
	...
	printf("Comparing cbc results: %d\n", memcmp(output_buffer, cipher, AES_BLOCK_SIZE * 2));
