...
#ifndef CTR_SDMMC_IMPLEMENTATION_HPP_
#define CTR_SDMMC_IMPLEMENTATION_HPP_
...
namespace ctr9
{
	 ...
	 *
	 *	@tparam Read Type of the sdmmc read function to use.
	 *
	 ...
	 */
	template<class Read>
	int ctr_sdmmc_implementation_read(void *buffer, size_t buffer_size, uint64_t position, size_t count, Read read);

	/** @brief General implementation for writing bytes using sdmmc functions.
	 *
	 *	@tparam Read Type of the sdmmc read function to use.
	 *	@tparam Write Type of the sdmmc write function to use.
	 *
	...
	int ctr_sdmmc_implementation_write(const void *buffer, size_t buffer_size, uint64_t position, Read read, Write write);
	 ...
	 */
	template<class Read>
	int ctr_sdmmc_implementation_read_sector(void *buffer, size_t buffer_size, size_t sector, size_t count, Read read);
	...
	int ctr_sdmmc_implementation_write_sector(const void *buffer, size_t buffer_size, size_t sector, Write write);
}

#include "ctr_sdmmc_implementation.ipp"

#endif//CTR_SDMMC_IMPLEMENTATION_HPP_
